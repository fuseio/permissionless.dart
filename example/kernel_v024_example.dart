// Example: Creating and using a Kernel v0.2.4 smart account with EntryPoint v0.6
//
// This example demonstrates:
// 1. Creating a Kernel smart account (v0.2.4 with EntryPoint v0.6)
...
//
// USAGE:
//   dart run example/kernel_v024_example.dart              # Sponsored (free gas)
//   dart run example/kernel_v024_example.dart --self-fund  # Self-funded (requires ETH)
//
// REQUIREMENTS:
...
void main(List<String> args) async {
  ...
  print('='.padRight(60, '='));
  print('Kernel v0.2.4 Smart Account Example (EntryPoint v0.6)');
  ...
  // ================================================================
  // 1. Create Public Client and Kernel Smart Account (v0.2.4)
  // ================================================================
  //
  // Kernel v0.2.4 uses EntryPoint v0.6 (older standard).
  // Key features:
  // - ECDSA validator for signature validation
  // - ERC-1967 proxy pattern for upgradeability
  // - Nonce key of 0 for sequential transactions
  ...
  final account = createKernelSmartAccount(
    ...
    index: BigInt.from(2024), // Fresh index with correct v0.2.4 implementation
    publicClient: publicClient, // Pass client for address computation
  );

  print('Kernel version: ${KernelVersion.v0_2_4.value}');
  ...
  final bundler = createBundlerClient(
    url: pimlicoUrl,
    entryPoint: EntryPointAddresses.v06, // v0.6 for Kernel v0.2.4
  );
  ...
  // KernelSmartAccount has signUserOperationV06 but doesn't implement SmartAccountV06
  // So we call it directly on the account
  ...
  print('Account type: Kernel ${KernelVersion.v0_2_4.value}');
